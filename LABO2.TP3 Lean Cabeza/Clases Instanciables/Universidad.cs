...
namespace Clases_Instanciables
{
    public class Universidad
    {
        ...
        /// <summary>
        /// Retorna una cadena con la informacion de la universidad que recibe como parametro
        /// </summary>
        ...
        /// <summary>
        /// Corrobora si el alumno forma parte de la lista de alumnos de la universidad
        /// </summary>
        /// <param name="g">universidad a comparar</param>
        /// <param name="a">alumno a comparar</param>
        /// <returns>true si forma parte, false caso contrario</returns>
        ...
        /// <summary>
        /// Corrobora si el alumno NO forma parte de la lista de alumnos de la universidad
        /// </summary>
        /// <param name="g">universidad a comparar</param>
        /// <param name="a">alumno a comparar</param>
        ...
        /// <summary>
        /// Agrega un alumno a la lista de alumnos de la universidad en caso de que no este repetido
        /// </summary>
        ...
        /// <summary>
        /// Verifica si un profesor pertenece a la lista de profesores de una universidad
        /// </summary>
        /// <param name="g">universidad a comparar</param>
        /// <param name="i">profesor a comparar</param>
        /// <returns>true si pertenece, false caso contrario</returns>
        ...
        /// <summary>
        /// Verifica si un profesor NO  pertenece a la lista de profesores de una universidad
        /// </summary>
        /// <param name="g">universidad a comparar</param>
        /// <param name="i">profesor a comparar</param>
        ...
        /// <summary>
        /// Agrega un Profesor a la lista de profesores de la universidad en caso de que no este repetido
        /// </summary>
        ...
        /// <summary>
        /// Verifica que el profesor pertenezca a una clase ingresados por paramnetro
        /// </summary>
        ...
        /// <summary>
        /// Verifica que el profesor NO pertenezca a una clase ingresados por paramnetro
        /// </summary>
        /// <param name="u">universidad a comparar</param>
        /// <param name="clase"></param>
        /// <returns>Devuelve SI un profesor NO es de esa clase, de no existir ese profesor sera nulo</returns>
        public static Profesor operator !=(Universidad u, EClases clase)
        {
            Profesor retorno = null;
